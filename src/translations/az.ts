...
export const AZ = createTranslationObject('az', {
  ...
  USER_ALREADY_HAS_PASSWORD: 'İstifadəçinin artıq şifrəsi var. Hesabı silmək üçün şifrəni daxil edin.',
  USER_ALREADY_EXISTS_USE_ANOTHER_EMAIL: 'İstifadəçi artıq mövcuddur. Başqa bir e-poçt ünvanı istifadə edin.',

  // Session related errors
  FAILED_TO_CREATE_SESSION: 'Sessiya yaradıla bilmədi',
  FAILED_TO_GET_SESSION: 'Sessiya oxuna bilmədi',
  SESSION_EXPIRED: 'Sessiyanın vaxtı bitdi. Davam etmək üçün yenidən daxil olun.',
