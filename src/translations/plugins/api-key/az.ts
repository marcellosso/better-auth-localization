...
export const AZ = {
	...
	REFILL_AMOUNT_AND_INTERVAL_REQUIRED:
		"Yenidən doldurma intervalı verildikdə, yenidən doldurma məbləği tələb olunur",
	REFILL_INTERVAL_AND_AMOUNT_REQUIRED:
		"Yenidən doldurma məbləği verildikdə, yenidən doldurma intervalı tələb olunur",
	...
	EXPIRES_IN_IS_TOO_SMALL:
		"Müddət əvvəlcədən müəyyən edilmiş minimum dəyərdən kiçikdir.",
	EXPIRES_IN_IS_TOO_LARGE:
		"Müddət əvvəlcədən müəyyən edilmiş maksimum dəyərdən böyükdür.",
	...
	KEY_DISABLED_EXPIRATION:
		"Xüsusi açar üçün bitmə vaxtı dəyərləri deaktiv edilib.",
	INVALID_API_KEY: "Yanlış API açarı.",
	INVALID_USER_ID_FROM_API_KEY:
		"API açarından əldə edilən istifadəçi ID-si yanlışdır.",
	INVALID_API_KEY_GETTER_RETURN_TYPE:
		"API açarı getter-i yanlış tip qaytardı. Gözlənilən: string.",
